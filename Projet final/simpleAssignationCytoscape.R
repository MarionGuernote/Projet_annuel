SimpleAssignationCy <- function(contentAssignation, tokenAssignation, edges, nodes, tokenValues) {
  ...
  tokenValues = rbind(tokenValues,tableSimpleTokenAsign[1],tableSimpleTokenAsign[3], .id= NULL)
  ...
  simpleAssign <- list("edges" = edges, "nodes" = nodes, "valueToken" = bindValueToken)
  return(simpleAssign); 
